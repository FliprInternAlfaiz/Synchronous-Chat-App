...
import ProfileInfo from "./component/profileInfo"  // Import with the correct name
import NewDm from './component/new-Dm';
import { apiClient } from '@/lib/api-client';
import { GET_CONTACT } from '@/utils/constant';
...
if(response){
  setDirectMessageContact(response.data);
  ...
  return (
    <div className='relative md:w-[35vw] lg:-w[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-2 border-[#2f303b] w-full'>
      ...
      <ProfileInfo /> {/* Render the component correctly */}
    </div>
  )
}
